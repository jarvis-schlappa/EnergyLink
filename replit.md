...
3.  **Mock Service:** Provides realistic simulated E3DC data for development when no hardware is connected.
...
- **Unified Mock Server**: A dedicated Node.js process (`server/unified-mock.ts`) simulates KEBA Wallbox UDP, E3DC Modbus TCP, and FHEM HTTP for comprehensive UI development and testing without physical hardware. This mock server ensures realistic state synchronization between simulated devices.
